...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Ápr 17. 22:40
...
(1, 'Kurucz', '186332', 'kuruczjanos@gmail.com', 6303273051, 'Kurucz János', 1, '../img/users/66193b676f141_admin.jpg', ''),
(2, 'Meggyesi', '123456789', 'meggyesireka@gmail.com', 6222222222, 'Meggyesi Réka', 1, '../img/users/66193b676f141_admin.jpg', ''),
...
(25, 'mintaFelhasznalo', 'minta', 'minta@gmail.com', 36305558888, 'MintaFelhasználó', 0, '../img/users/66193b676f141_admin.jpg', 'JkAdeZncB7r1TXo');
...
--
ALTER TABLE `ads`
  MODIFY `AdAz` int(15) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Hírdetés azonosító', AUTO_INCREMENT=30;
...
--
ALTER TABLE `subscribes`
  MODIFY `subAz` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT a táblához `users`
--
ALTER TABLE `users`
  MODIFY `UserAz` smallint(15) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Felhasználó azonosítója', AUTO_INCREMENT=26;
